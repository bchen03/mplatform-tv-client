            ...
            <div className="container-fluid">
                ...
                <div className="container my-4">
                    <form style={{ width: "600px", margin: "0 auto"}}>
                        ...
                        <MdbInput id="email" name="Your Email" value={this.state.inputs[0] || ""} inputChanged={(e) => this.inputChanged(0, e)} />
                        <MdbInput id="password" name="Your Password" value={this.state.inputs[1] || ""} inputChanged={(e) => this.inputChanged(1, e)} />
